		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsappimdmaintainconfig-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsappimdmaintainconfig-display": {
								"semanticObject": "comsappimdmaintainconfig",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.pimd.maintainconfig",
									"url": sap.ui.require.toUrl("com/sap/pimd/maintainconfig")
								}
							}
						}
					}
